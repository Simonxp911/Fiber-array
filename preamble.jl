...
using Optim             #for fitting the effective β-factor
...
struct SysPar
    ...
    initialState::Union{Tuple, Vector}              # Initial state for time evolution
    ...
    function SysPar(ρf::Real, n::Real, ω::Real,
                    ...
                    initialState::Union{Tuple, Vector}, initialStateDescription::String,
                    ΩDriveOn::Bool,
